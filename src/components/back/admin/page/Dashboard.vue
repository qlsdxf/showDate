            ...
            <el-col>
              <el-card shadow="hover">
								<div slot="header" class="clearfix">
									<span>店铺销量排行(销售总额: {{totalTurnover}}元)</span>
								</div>
								<p v-for="(item, i) in Ranking">
									{{item.name}}
									<el-progress  :color="colors[i]" :percentage="item.turnover/totalTurnover*100" :format="format" color="#8e71c7"></el-progress>
								</p>
  ...
  data () {
    return {
			...
			colors:["#64577a",],
			 ...
			 time:"2018-07-20",
             Ranking:[
				 {name:"Vue.js",turnover:50000}
                 ,{name:"Java",turnover:20000},
				 {name:"Script",turnover:5000},
				 {name:"CSS3",turnover:1000},
                 {name:"HTML5",turnover:1000}
			 ],
    }
  },
	methods: {
        ...
        format(percentage) {
            return Math.round(this.totalTurnover*percentage/100)+'元';
        },
		color16(){
