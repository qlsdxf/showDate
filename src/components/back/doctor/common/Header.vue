<template>
    <div class="header">
        ...
        <div class="logo">医生后台界面管理</div>
        <div class="header-right">
            <div class="header-user-icon">

                <div class="user-avator">
                    <img :src="doctor.doctorAvatar" alt="">
                </div>
                <!-- 用户名下拉菜单 -->
                <el-dropdown trigger="click" @command="handleCommand">
                    <span class="el-dropdown-link">
                        {{doctor.doctorName}}<i class="el-icon-arrow-down el-icon--right"></i>
                    </span>
...
export default {
    mounted(){
        ...
        console.log(this.doctor.doctorAvatar)
    },
    data () {
        return {
          collpase:false,
