...
<!--<script>-->
    ...
    <!--export default {-->
        ...
        <!--methods: {-->
            <!--getProvince() {-->
                <!--this.$axios.post("/api/api/user/getProvince").then((res)=> {-->
            ...
            <!--},-->
            <!--getCity(val) {-->
                <!--this.$axios.post("/api/api/user/getCity/"+val).then((res)=> {-->
            ...
            <!--},-->
            <!--getCounty(val) {-->
                <!--this.$axios.post("/api/api/user/getCounty/"+val).then((res)=> {-->
            ...
            <!--getVerification(){-->
                ...
                <!--if (this.form.userPhone != '') {-->
                   ...
                   <!--} else {-->
                       <!--this.$axios.get("/api/api/login/verification/"+this.form.userPhone).then((res)=>{-->
                           <!--this.$message.success(res.data.message)-->
                       <!--})-->
                       <!--this.display=2;-->
                       <!--let that = this;-->
