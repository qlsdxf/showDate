            ...
            <el-row style="width: 100%">
                <el-col style="margin-left:1%;width: 45%" >
                    <div class="grid-content">
                        <el-form-item label="医生昵称"required  required style="width: 98%;" >
                ...
                <el-col style="margin-left:1%;width: 45%" >
                    <div class="grid-content">
                        <el-form-item label="密码"  style="width: 98%;" required>
                            <el-input v-model="form.doctorPassword" type="password"  placeholder="密码位数不能于8位" show-password></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col style="margin-left:1%;width: 45%" >
                    <div class="grid-content">
                        <el-form-item label="重复密码" style="width: 98%;" required>
                            <el-input v-model="password2" type="password"  placeholder="再次输入密码" show-password></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col style="margin-left:1%;width: 45%" >
                    <div class="grid-content">
                        <el-form-item label="选择性别" required>
                            <el-radio-group v-model="form.doctorSex" style="width: 150px;">
        ...
        methods: {
            ...
            register(){
                ...
                && this.form.doctorCertificate != '' && this.form.doctorIdCard != '') {
                    ...
                    let url = "/api/message/provide/doctor/addDoctor";
