<template>
    <div class="order">
        <div v-if="show" style="width: 100%;height: 50%">
            <el-empty description="暂时没有需要签收的订单"></el-empty>
        </div>
        <div v-for="item in order"  style="margin-top: 20px">
            ...
            <el-card >
                <div class="content">
                    ...
                    <div v-if="item.delivery != null && item.delivery != undefined" style="float: left;margin-left: 0px;font-size: 16px;text-align: center;width: 300px">
                        <div style="margin-top: 0px">快件由{{item.delivery.deliveryStartAddress}}发往{{item.delivery.deliveryEndAddress}}</div>
                    ...
                    <div style="float: left;margin-left: 80px;font-size: 16px;font-weight: bolder;margin-top: 20px;width: 70px">
