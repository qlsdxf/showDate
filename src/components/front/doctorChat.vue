    ...
    <div>
        ...
        <div class="chat_main"  id="tp">
            <div v-for="(index,item) in content" :key="item" >
                ...
                <div class="right" v-if="index.chatType == 2">
                ...
                <div class="left" v-if="index.chatType == 1">
                    <div style="float: top;display: flex;">
                        <div style="float: right;margin-left: 2px">
    ...
    export default {
        ...
        methods: {
            ...
            initWebSocket(){ //初始化weosocket
                ...
                this.webSocket = new WebSocket("ws://127.0.0.1:8002/websocket/" + this.userId + "_" + this.doctorId);
            ...
            getDoctor(doctorId){
                this.$axios.get("/api/message/provide/doctor/getDocotorByDoctor/" + doctorId).then((res)=>{
