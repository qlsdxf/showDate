            ...
            <div v-for="(index,item) in content" :key="item" >
                <div class="right" v-if="index.chatType == 1">
                    ...
                    <div style="margin-top: 10px">
                        <span style="font-size: 12px;color: #B0B0B0;margin-left: 100px;margin-top: 10px">{{index.chatCreateTime| getTime(index.chatCreateTime)}}</span>
                    </div>
                ...
                <div class="left" v-if="index.chatType == 2">
                    ...
                    <div style="margin-top: 10px">
                        <span style="font-size: 12px;color: #B0B0B0;margin-left: 100px;">{{index.chatCreateTime| getTime(index.chatCreateTime)}}</span>
                    </div>
                </div>
            ...
            getRandDoctor() {
                ...
                this.$axios.post("/api/message/provide/doctor/getRandDoctor",data).then((res)=>{
                    if (res.data.code != 200) {
                        this.$message.success("该商家暂时没有医生！！已转至系统医生！！")
                        this.$router.push({
                            path: '/personChat',
                        })
